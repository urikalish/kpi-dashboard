...
const RELEASE_REGEX = /R_E_L_E_A_S_E/gi;
const SPACE = 196009;
...
const metadata = {
    ...
    LRC: {
        WS: 4001,
        URL: 'internal-api/shared_spaces/196009/workspaces/4001/trend?graph_extenders=burnUpExtender&entity-name=work_item&rangeOperator=releasePeriod&xAxisUnit=days&cumulative=true&timezone=UTC%252B02%253A00&yaxis=story_points&range=[R_E_L_E_A_S_E]&sets=%5B%7B%22query%22%3A%22(subtype%20IN%20%27story%27%2C%27defect%27%2C%27quality_story%27%3Bphase%3D%7Bid%20IN%20%27phase.defect.closed%27%2C%27phase.defect.rejected%27%2C%27phase.defect.duplicate%27%2C%27phase.story.done%27%2C%27phase.quality_story.done%27%7D%3Brelease%3D%7Bid%3DR_E_L_E_A_S_E%7D)%22%2C%22groupBy%22%3Afalse%2C%22key%22%3A%22done%22%7D%2C%7B%22query%22%3A%22(subtype%20IN%20%27story%27%2C%27defect%27%2C%27quality_story%27%3Brelease%3D%7Bid%3DR_E_L_E_A_S_E%7D)%22%2C%22groupBy%22%3Afalse%2C%22key%22%3A%22total%22%7D%5D&entity-subtypes=story%2Cdefect%2Cquality_story',
        RELEASE: 48002
    },
    SRL: {
        WS: 4001,
    ...
    LRPROTO: {
        WS: 4001,
        URL: 'internal-api/shared_spaces/196009/workspaces/4001/trend?graph_extenders=burnUpExtender&entity-name=work_item&rangeOperator=releasePeriod&xAxisUnit=days&cumulative=true&timezone=UTC%252B02%253A00&yaxis=story_points&range=%5bR_E_L_E_A_S_E%5d&sets=%5B%7B%22query%22%3A%22(subtype%20IN%20%27story%27%2C%27defect%27%2C%27quality_story%27%3Bphase%3D%7Bid%20IN%20%27phase.defect.closed%27%2C%27phase.defect.rejected%27%2C%27phase.defect.duplicate%27%2C%27phase.story.done%27%2C%27phase.quality_story.done%27%7D%3Brelease%3D%7Bid%3DR_E_L_E_A_S_E%7D)%22%2C%22groupBy%22%3Afalse%2C%22key%22%3A%22done%22%7D%2C%7B%22query%22%3A%22(subtype%20IN%20%27story%27%2C%27defect%27%2C%27quality_story%27%3Brelease%3D%7Bid%3DR_E_L_E_A_S_E%7D)%22%2C%22groupBy%22%3Afalse%2C%22key%22%3A%22total%22%7D%5D&entity-subtypes=story%2Cdefect%2Cquality_story',
        RELEASE: 47003
    }
};
...
module.exports.getLRData = function getLRData(type) {
    ...
    return Promise.all([
        commonRequests.getLatestReleaseBurnUp(octaneInstance, metadata[type].URL.replace(RELEASE_REGEX, metadata[type].RELEASE)),
        getReleaseData(type)
    ]).then(lrResults => {
        returnObject.releaseData = lrResults[0];
        returnObject.releaseResult = commonRequests.getReleaseResult(lrResults[0]);
        returnObject.releaseMetadata = lrResults[1];
        return returnObject;
    }).catch(() => {
        return returnObject;
    });
